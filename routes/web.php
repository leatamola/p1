...
Route::get('/all','IndexController@listAll');
Route::get('/destacados','IndexController@destacadosShow');
Route::get('/product-detail/{id}','IndexController@detialpro');
Route::get('/about','IndexController@aboutShow');
////// get Attribute ////////////
Route::get('/get-product-attr','IndexController@getAttrs');
// SEARCH route
Route::get('/search', 'SearchController@search')->name('busqueda');
Route::get('/categories', 'SearchController@search');
Route::get('/categories/{name}', 'SearchController@searchCategory');

// EMAIL SEND
Route::get('/contacto','SendEmailController@create');
Route::post('/contacto', 'SendEmailController@store');
