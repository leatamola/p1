                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="text-align: center;"><img src="{{url('/products/banner/',$product->banner)}}" alt="" width="50"></td>
                            <td style="vertical-align: middle;">{{$product->p_name}}</td>
                            <td style="vertical-align: middle;">{{$product->category->name}}</td>
                            <td style="vertical-align: middle;">{{$product->tel}}</td>
                            <td style="vertical-align: middle;">{{$product->email}}</td>
                            <td style="vertical-align: middle;">{{$product->whatsapp}}</td>
